...
these tests were limited to single socket hardware. It has also been shown that the JBM
services consume on average 20\% of total power needed. The previous works show that the
